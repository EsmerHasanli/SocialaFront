...
const AddPost = () => {
  ...
  return (
    <section id='add-post'>
      ...
      <Modal style={{textAlign:'center'}} title="Create Status" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        <Divider/>
        ...
        <ul style={{margin:'10px', display:'flex', gap:'15px'}}>
            ...
            <li style={{ display:'flex', alignItems:'center', justifyContent:'center', borderRadius:'25px', padding:'4px 8px', gap:'8px', border:'1px solid rgb(255,237,213)', backgroundColor:'rgb(255,228,230)', color:'rgb(234,88,12)'}}><span>Feeling</span></li>
            <li style={{ display:'flex', alignItems:'center', justifyContent:'center', borderRadius:'25px', padding:'4px 8px', gap:'8px', border:'1px solid rgb(255,228,230)', backgroundColor:'rgb(255,228,230)', color:'rgb(220,38,38)'}}><span>Check In</span></li>
        </ul>
      </Modal>
    </section>
  )
